...
namespace App\Business\SubjectAuth;

use App\Business\SubjectAuthInterface;
...
class AdminAuth extends AbstractBusiness implements SubjectAuthInterface
{
    ...
    public function __construct(ContainerInterface $container)
    {
        ...
        $this->adminRepository = $this->getDoctrine()->getRepository('Admin');
    }
    ...
    {
        return $this->adminRepository->findBy($rules);
    }
    ...
    public function create(Admin $admin, $password)
    {
        ...
        try {
            ...
            $userAuth->setSubjectType($this->getParameter('subject_admin'));
            $userAuth->setSalt($salt);
            $userAuth->setPassword($userAuthBusiness->encryptPassword($password, $salt));
